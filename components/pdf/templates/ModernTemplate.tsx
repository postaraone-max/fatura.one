      ...
      <Page size="A4" style={styles.page}>
        <View style={styles.header}>
          <View>
            ...
            <Text style={styles.subtitle}>Modern Template</Text>
          </View>
          <View>
            <Text style={styles.value}>#{data.invoiceNumber}</Text>
            <Text style={styles.label}>Date: {data.createdAt}</Text>
            {data.dueDate && <Text style={styles.label}>Due: {data.dueDate}</Text>}
          </View>
        </View>
